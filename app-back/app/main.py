...
app.include_router(
    downgrades.router,
    prefix=f"{settings.API_V1_PREFIX}/downgrades",
    tags=["downgrades"]
)
...
app.include_router(
    git_promotions.router,
    prefix=f"{settings.API_V1_PREFIX}/git-promotions",
    tags=["git-promotions"]
)
