...
| File | Purpose | Action |
|------|---------|--------|
| `n8n-ops-backend/app/api/endpoints/untracked_workflows.py` | API endpoints for scan + onboarding | create |
| `n8n-ops-backend/app/services/untracked_workflows_service.py` | Business logic: scan n8n, detect untracked | create |
| `n8n-ops-backend/app/schemas/untracked_workflow.py` | Pydantic schemas for API request/response | create |
| `n8n-ops-backend/app/services/n8n_client.py` | List workflows per environment (existing `get_workflows()` method) | no change needed |
| `n8n-ops-backend/app/services/database.py` | Add method for atomic canonical+mapping creation | modify |
| `n8n-ops-backend/app/main.py` | Register new router | modify |

### Frontend Files

| File | Purpose | Action |
|------|---------|--------|
| `n8n-ops-ui/src/pages/UntrackedWorkflowsPage.tsx` | Main page for viewing and onboarding untracked workflows | create |
| `n8n-ops-ui/src/lib/api-client.ts` | Add API methods for untracked workflow detection | modify |
| `n8n-ops-ui/src/types/index.ts` | Add types for untracked workflow responses | modify |
| `n8n-ops-ui/src/App.tsx` | Add route for the new page | modify |
| `n8n-ops-ui/src/components/AppLayout.tsx` | Add navigation link to the page | modify |

### Test Files

| File | Purpose | Action |
|------|---------|--------|
| `n8n-ops-backend/tests/test_untracked_workflows.py` | Unit tests for backend service | create |
| `n8n-ops-ui/tests/untracked-workflows.spec.ts` | Playwright E2E verification test | create |

## 7. Implementation Tasks

```tasks
- [ ] T001: Create Pydantic schemas for untracked workflows | File: n8n-ops-backend/app/schemas/untracked_workflow.py
- [ ] T002: Create UntrackedWorkflowsService with scan logic | File: n8n-ops-backend/app/services/untracked_workflows_service.py
- [ ] T003: Add atomic canonical+mapping creation method to database service | File: n8n-ops-backend/app/services/database.py
- [ ] T004: Create API endpoints for untracked workflows | File: n8n-ops-backend/app/api/endpoints/untracked_workflows.py
- [ ] T005: Register untracked workflows router in main.py | File: n8n-ops-backend/app/main.py
- [ ] T006: Add UntrackedWorkflow types to frontend types | File: n8n-ops-ui/src/types/index.ts
- [ ] T007: Add API client methods for untracked workflows | File: n8n-ops-ui/src/lib/api-client.ts
- [ ] T008: Create UntrackedWorkflowsPage component | File: n8n-ops-ui/src/pages/UntrackedWorkflowsPage.tsx
- [ ] T009: Add route for UntrackedWorkflowsPage | File: n8n-ops-ui/src/App.tsx
- [ ] T010: Add navigation link in sidebar | File: n8n-ops-ui/src/components/AppLayout.tsx
- [ ] T011: Create backend unit tests | File: n8n-ops-backend/tests/test_untracked_workflows.py
- [ ] T012: Create Playwright verification test | File: n8n-ops-ui/tests/untracked-workflows.spec.ts
- [ ] T013: Run verification test and delete test file | File: n8n-ops-ui/tests/untracked-workflows.spec.ts
```
