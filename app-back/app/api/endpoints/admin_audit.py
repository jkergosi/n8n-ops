...
class AuditActionType(str, Enum):
    ...
    ENVIRONMENT_BACKUP_STARTED = "ENVIRONMENT_BACKUP_STARTED"
    ENVIRONMENT_BACKUP_COMPLETED = "ENVIRONMENT_BACKUP_COMPLETED"
    ENVIRONMENT_BACKUP_FAILED = "ENVIRONMENT_BACKUP_FAILED"
    ENVIRONMENT_REVERT_STARTED = "ENVIRONMENT_REVERT_STARTED"
    ENVIRONMENT_REVERT_COMPLETED = "ENVIRONMENT_REVERT_COMPLETED"
    ENVIRONMENT_REVERT_FAILED = "ENVIRONMENT_REVERT_FAILED"
    ENVIRONMENT_KEEP_HOTFIX_STARTED = "ENVIRONMENT_KEEP_HOTFIX_STARTED"
    ENVIRONMENT_KEEP_HOTFIX_COMPLETED = "ENVIRONMENT_KEEP_HOTFIX_COMPLETED"
    ENVIRONMENT_KEEP_HOTFIX_FAILED = "ENVIRONMENT_KEEP_HOTFIX_FAILED"
